...
Once the `conda-forge` channel has been enabled, `panel-chemistry` can be installed with:

```
conda install panel-chemistry
```

It is possible to list all of the versions of `panel-chemistry` available on your platform with:
